  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-white text-slate-900 p-4 relative overflow-hidden">
      ...
      <div className="text-center mb-10 z-10">
        <h1 className="text-6xl font-black mb-3 bg-gradient-to-r from-pink-400 to-rose-400 bg-clip-text text-transparent">Hum The Song</h1>
        <p className="text-slate-600 text-lg">Hum the melody and let your team guess the song!</p>
      </div>
        ...
        <div className="relative bg-white p-12 rounded-3xl shadow-lg border border-slate-200 text-center">
          {currentSong ? (
            <div className="space-y-6">
              <div className="text-6xl font-black text-transparent bg-gradient-to-r from-pink-400 via-rose-400 to-orange-400 bg-clip-text">
                {currentSong.name}
              </div>
